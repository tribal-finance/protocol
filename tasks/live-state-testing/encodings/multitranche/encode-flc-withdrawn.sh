...
npx hardhat encode-pool-initializer \
  ...
  --tranches-count 6 \
  --tranche-a-p-rs-wads "0.1,0.1,0.2,0.3,.66,.75" \
  --tranche-boosted-a-p-rs-wads "0.1,0.1,0.2,0.99,.99,.99" \
  --tranche-boost-ratios "2,2,3,4,3.2,3.442" \
  --tranche-coverages-wads "1,1,1,0.4,.069,.82765" \
  --funding-split-wads "0.65,0.65:0.175,0.175:0.1,0.1:0.05,0.05:0.015,0.015:0.01,0.01"
