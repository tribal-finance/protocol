...
npx hardhat encode-pool-initializer \
  --name "v1.0.3 FUNDING_FAILED 8T" \
  --token "TST FUNDING_FAILED" \
  ...
  --tranches-count 8 \
  --tranche-a-p-rs-wads "0.1,0.1,0.2,0.3,.66,.75,.1,.1" \
  --tranche-boosted-a-p-rs-wads "0.1,0.1,0.2,0.99,.99,.99,1,.2" \
  --tranche-boost-ratios "2,2,3,4,3.2,3.442,2,10" \
  --tranche-coverages-wads "1,1,1,0.4,.069,.82765,.5,1" \
  --funding-split-wads "0.05,0.05:0.175,0.175:0.1,0.1:0.05,0.05:0.015,0.015:0.01,0.01:0.1,0.1:0.5,0.5"
