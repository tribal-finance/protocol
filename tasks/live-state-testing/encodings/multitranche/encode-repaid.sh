...
npx hardhat encode-pool-initializer \
  ...
  --tranches-count 11 \
  --tranche-a-p-rs-wads "0.1,0.1,0.2,0.3,.66,.75,.1,.1,.2,0.98,.420" \
  --tranche-boosted-a-p-rs-wads "0.1,0.1,0.2,0.99,.99,.99,1,.2,.5,.99,.69" \
  --tranche-boost-ratios "2,2,3,4,3.2,3.442,2,10,100,1000,0.4" \
  --tranche-coverages-wads "1,1,1,0.4,.069,.82765,.5,1,1,.5,1" \
  --funding-split-wads "0.02,0.02:0.175,0.175:0.1,0.1:0.05,0.05:0.015,0.015:0.0075,0.0075:0.1,0.1:0.25,0.25:0.03,0.03:0.0025,0.0025:.25,.25"
