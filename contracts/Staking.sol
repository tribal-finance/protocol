...
contract StakingContract is Ownable {
    ...
    IERC20 public rewardToken; // The ERC-20 token used for rewards
    uint256 public rewardPerTokenStaked; // The amount of rewardToken per token staked
    uint256 public totalStaked; // The total amount of token staked
    ...
    constructor(IERC20 _token, IERC20 _rewardToken, uint256 _rewardPerTokenStaked) {
        token = _token;
    ...
    // Owner can add more reward tokens to the contract
